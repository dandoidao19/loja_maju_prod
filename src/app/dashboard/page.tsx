...
// app/dashboard/page.tsx - VERSÃO COM CONTROLE DE AMBIENTE E CAIXA UNIVERSAL
'use client'
...
import CaixaUnificado from '@/components/CaixaUnificado' // Importando o novo componente
...
export default function Dashboard() {
  ...
  const menuItems = [
    { id: 'dashboard', label: '📊 Caixa Universal', icon: '📊', color: 'blue' },
